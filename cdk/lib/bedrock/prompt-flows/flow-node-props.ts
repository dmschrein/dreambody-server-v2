// cdk/lib/bedrock/prompt-flows/flow-node-props.ts
 ...
 */
export interface KnowledgeBaseRetrieveAndGenerateNodeProps
  extends KnowledgeBaseRetrieveNodeProps {
  /**
